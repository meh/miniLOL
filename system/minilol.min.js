...
b)return a[c]},fixDOM:function(b){if(!b||Prototype.Browser.Good)return b;if(Prototype.Browser.IE){var a=b;b={};b._real=a;b.documentElement=a.documentElement;b.getElementsByTagName=function(c){return this._real.getElementsByTagName(c)};b.getElementById=function(c){return miniLOL.utils.getElementById.call(this._real,c)}}else b.getElementById=miniLOL.utils.getElementById;return b},checkXML:function(b,a){var c=false;b||(c="There's a syntax error.");if(b.documentElement.nodeName=="parsererror")c=b.documentElement.textContent;
if(a&&c){miniLOL.error("Error while parsing #{path}\n\n#{error}".interpolate({path:a,error:c}));return c}return c},getFirstText:function(b){for(var a=0;a<b.length;a++)switch(b[a].nodeType){case Node.ELEMENT_NODE:return"";case Node.CDATA_SECTION_NODE:case Node.TEXT_NODE:if(b[a].nodeValue.replace(/[\s\n]/g,""))return b[a].nodeValue;break}return""},fileExists:function(b){var a=false;new Ajax.Request(b,{method:"head",asynchronous:false,onSuccess:function(){a=true}});return a},includeCSS:function(b){var a=
miniLOL.utils.fileExists(b);if(a){a=new Element("link",{rel:"stylesheet",href:b,type:"text/css"});$$("head")[0].insert(a)}return a},include:function(b){var a=null;new Ajax.Request(b,{method:"get",asynchronous:false,evalJS:false,onSuccess:function(c){try{a=window.eval(c.responseText)}catch(d){}}});return a},require:function(b){var a,c;new Ajax.Request(b,{method:"get",asynchronous:false,evalJS:false,onSuccess:function(d){try{a=window.eval(d.responseText)}catch(e){c=e;c.fileName=b;c.lineNumber-=5}},
onFailure:function(d){c=new Error("Failed to retrieve the file (#{status} - #{statusText}).".interpolate(d));c.fileName=b;c.lineNumber=0}});if(c)throw c;return a}}};
