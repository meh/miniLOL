...
getStyle:function(b,a){var b=c(b),a=a==="float"||a==="styleFloat"?"cssFloat":a.camelize(),h=b.style[a];if(!h||h==="auto")h=(h=document.defaultView.getComputedStyle(b,null))?h[a]:null;return a==="opacity"?h?parseFloat(h):1:h==="auto"?null:h},setOpacity:function(b,a){b=c(b);a==1||a===""?a="":a<1.0E-5&&(a=0);b.style.opacity=a;return b},getOpacity:function(b){return d.getStyle(b,"opacity")}});if("styleFloat"in t.style)u.getStyle=S,u.setOpacity=r,u.getOpacity=I;a.Element.Storage={UID:0};var V="uniqueID"in
t;V&&(w=B);Object.extend(u,{getStorage:s,store:function(b,a,h){if(b=c(b)){var d=s(b);arguments.length===2?d.update(a):d.set(a,h);return b}},retrieve:function(b,a,h){if(b=c(b)){var b=s(b),d=b.get(a);Object.isUndefined(d)&&(b.set(a,h),d=h);return d}}});var Y={},N=d.Methods.ByTag,R=Prototype.BrowserFeatures;if(!R.ElementExtensions&&"__proto__"in t)a.HTMLElement={},a.HTMLElement.prototype=t.__proto__,R.ElementExtensions=!0;q=function(b){if(typeof window.Element==="undefined")return!1;var a=window.Element.prototype;
if(a){var h="_"+(Math.random()+"").slice(2),b=document.createElement(b);a[h]="x";b=b[h]!=="x";delete a[h];return b}return!1}("object");var U={};R.SpecificElementExtensions&&(G=q?O:Prototype.K);Object.extend(a.Element,{extend:G,addMethods:function(b){arguments.length===0&&(Object.extend(Form,Form.Methods),Object.extend(Form.Element,Form.Element.Methods),Object.extend(d.Methods.ByTag,{FORM:Object.clone(Form.Methods),INPUT:Object.clone(Form.Element.Methods),SELECT:Object.clone(Form.Element.Methods),
