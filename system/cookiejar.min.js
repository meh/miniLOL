...
str=document.cookie;for(CJRe=new RegExp("^"+this.appendString);(match=keyRe.exec(str))!=undefined;)CJRe.test(match[0].strip())&&keys.push(match[0].strip().gsub("^"+this.appendString,""));return keys}};CookieJar.prototype.set=CookieJar.prototype.put;
