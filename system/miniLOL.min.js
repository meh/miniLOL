...
miniLOL={version:"1.2",initialize:function(){if(miniLOL.initialized)throw Error("miniLOL has already been initialized.");miniLOL.Template.Engine.load("system/templates/HAML.js",{minified:!0});miniLOL.initialized=!1;miniLOL.path=location.href.match(/^\w+:\/\/.*?(\/.*?)(#|$)/)[1];miniLOL.storage=new miniLOL.Storage("miniLOL.core");miniLOL.resources={};miniLOL.tmp={};[function(){Event.observe(document,":resource.loaded",function(a){if(!(a.memo.resource.name!="miniLOL.config"||a.memo.arguments[0]!="resources/config.xml")){miniLOL.config.core||
(miniLOL.config.core={});if(!miniLOL.config.core.siteTitle)miniLOL.config.core.siteTitle="miniLOL #{version}".interpolate(miniLOL);if(!miniLOL.config.core.loadingMessage)miniLOL.config.core.loadingMessage="Loading...";if(miniLOL.config.core.homePage){if(miniLOL.config.core.homePage.charAt(0)!="#"&&!miniLOL.config.core.homePage.isURL())miniLOL.config.core.homePage="#"+miniLOL.config.core.homePage}else miniLOL.config.core.homePage="#home";$("__miniLOL.core.style")&&$("__miniLOL.core.style").remove();
miniLOL.config.core.style&&miniLOL.CSS.create(miniLOL.config.core.style,"__miniLOL.core.style");if(!document.title)document.title=miniLOL.config.core.siteTitle}});miniLOL.resource.set(new miniLOL.Resource("miniLOL.config",{initialize:function(){miniLOL.config=this.data},load:function(a){new Ajax.Request(a,{method:"get",asynchronous:!1,onSuccess:function(b){if(!miniLOL.Document.check(b.responseXML,a)){var b=miniLOL.Document.fix(b.responseXML).documentElement,c=b.getAttribute("domain")||"core";miniLOL.config[c]=
Object.extend(miniLOL.config[c]||{},Element.toObject(b))}},onFailure:function(b){miniLOL.error("miniLOL.config: Error while loading #{path} (#{status} - #{statusText})".interpolate({path:a,status:b.status,statusText:b.statusText}),!0)}});return miniLOL.error()?!1:!0},clear:function(){this.data=miniLOL.config={}}}));miniLOL.resource.get("miniLOL.config").load("resources/config.xml");$(document.body).update(miniLOL.config.core.loadingMessage);Event.fire(document,":initialization");Event.stopObserving(document,
":initialization")},function(){miniLOL.resource.set(new miniLOL.Resource("miniLOL.menus",{load:function(a){new Ajax.Request(a,{method:"get",asynchronous:!1,onSuccess:function(b){miniLOL.Document.check(b.responseXML,a)||(b=miniLOL.Document.fix(b.responseXML),miniLOL.menus["default"]=b.getElementById("default"),$A(b.documentElement.childNodes).each(function(a){if(a.nodeType==Node.ELEMENT_NODE){var b=a.getAttribute("id");!b&&!miniLOL.menus["default"]?miniLOL.menus["default"]=a:miniLOL.menus[b]=a}}),
miniLOL.menus["default"]||miniLOL.error("Error while analyzing menus.xml\n\nNo default menu was found.",!0))}});return miniLOL.error()?!1:!0},clear:function(){this.data=miniLOL.menus={}}}));miniLOL.resource.get("miniLOL.menus").load("resources/menus.xml")},function(){miniLOL.resource.set(new miniLOL.Resource("miniLOL.pages",{load:function(a,b){new Ajax.Request(a,{method:"get",asynchronous:!1,onSuccess:function(c){miniLOL.Document.check(c.responseXML,a)||miniLOL.Document.fix(c.responseXML).xpath("//page").each(function(a){var c=
a.getAttribute("id");delete miniLOL.pages.cache[c];miniLOL.pages.data[c]=a})},onFailure:function(c){b||miniLOL.error("miniLOL.pages: Error while loading #{path} (#{status} - #{statusText})".interpolate({path:a,status:c.status,statusText:c.statusText},!0))}});return miniLOL.error()?!1:!0},clear:function(){miniLOL.pages=this.data={data:{},cache:{}}}}));miniLOL.resource.get("miniLOL.pages").load("resources/pages.xml",!0)},function(){miniLOL.resource.set(new miniLOL.Resource("miniLOL.functions",{load:function(a){new Ajax.Request(a,
{method:"get",asynchronous:!1,onSuccess:function(b){miniLOL.Document.check(b.responseXML,a)||miniLOL.Document.fix(b.responseXML).xpath("//function").each(function(c){try{miniLOL.functions[c.getAttribute("name")]=new Function("var text = arguments[0]; var args = arguments[1]; arguments = args; #{code}; return text;".interpolate({code:c.firstChild.nodeValue}))}catch(b){miniLOL.error("Error while creating `#{name}` wrapper from #{path}:\n\n#{error}".interpolate({name:c.getAttribute("name"),path:a,error:b.toString()}),
!0)}})},onFailure:function(b){miniLOL.error("miniLOL.functions: Error while loading #{path} (#{status} - #{statusText})".interpolate({path:a,status:b.status,statusText:b.statusText}),!0)}});return miniLOL.error()?!1:!0},clear:function(){miniLOL.functions=this.data={}},render:function(a,b,c){a.split(/\s*,\s*/).each(function(a){Object.isFunction(this.data[a])&&(b=this.data[a](b,c))},this);return b}}));miniLOL.resource.get("miniLOL.functions").load("resources/functions.xml")},function(){miniLOL.config.core.theme?
miniLOL.error(!miniLOL.theme.load(miniLOL.config.core.theme)):miniLOL.error(!miniLOL.theme.deprecated())},function(){miniLOL.menu.enabled()&&miniLOL.menu.set(miniLOL.config.core.loadingMessage)},function(){miniLOL.content.set("Loading modules...");miniLOL.resource.set(new miniLOL.Resource("miniLOL.modules",{load:function(a,b){new Ajax.Request(a,{method:"get",asynchronous:!1,onSuccess:function(c){if(!miniLOL.Document.check(c.responseXML,a)){miniLOL.module.path=c.responseXML.documentElement.getAttribute("path")||
"modules";var d=miniLOL.Document.fix(c.responseXML).xpath("//module").filter(function(a){return a.getAttribute("name")});d.each(function(a,c){b&&miniLOL.content.set("Loading `#{name}`... [#{number}/#{total}]".interpolate({name:a.getAttribute("name"),number:c+1,total:d.length}));miniLOL.module.load(a.getAttribute("name"))||miniLOL.error(!0);if(miniLOL.error())throw $break;},this)}},onFailure:function(a){miniLOL.error("Error while loading modules.xml (#{status} - #{statusText})".interpolate(a),!0)}});
return miniLOL.error()?!1:!0},clear:function(){miniLOL.modules=this.data={}}}));miniLOL.resource.get("miniLOL.modules").load("resources/modules.xml",!0)},function(){miniLOL.menu.enabled()&&miniLOL.menu.change("default")},function(){miniLOL.content.set("Checking dependencies...");try{miniLOL.module.dependencies.check()}catch(a){miniLOL.error("`#{module}` requires `#{require}`".interpolate(a),!0)}}].each(function(a){try{a()}catch(b){miniLOL.error(b.toString(),!0)}if(miniLOL.error())throw $break;});
if(miniLOL.error())return!1;Event.observe(document,"unload",function(a){Event.fire(document,":finalization",a)});Event.observe(document,":url.change",function(a){a.stopped||(a.memo?miniLOL.go(a.memo):miniLOL.go(miniLOL.config.core.homePage))});Event.observe(document,":go",miniLOL.tmp.fixScroll=function(){$(document.body).scrollTo()});miniLOL.config.core.initialization&&eval(miniLOL.config.core.initialization);miniLOL.go(/[#?]./.test(location.href)?location.href.replace(/^.*[#?]/,"#"):miniLOL.config.core.homePage);
Event.observe(document,":refresh",function(){miniLOL.resource.reload("miniLOL.config","miniLOL.pages","miniLOL.menus")});new PeriodicalExecuter(function(){Event.fire(document,":refresh")},miniLOL.config.core.refreshEvery||360);Event.fire(document,":initialized");Event.stopObserving(document,":initialized");miniLOL.initialized=!0},error:function(a,b,c){if(miniLOL.error.major)return!0;if(Object.isUndefined(a))return Boolean(miniLOL.error.major);if(Object.isBoolean(a))return miniLOL.error.major=a;if(!miniLOL.error.done){c=
c||miniLOL.theme.content()||document.body;$(c).update("<pre>"+a.replace(/<br\/>/g,"\n").escapeHTML()+"</pre>");miniLOL.error.done=!0;if(b)miniLOL.error.major=!0;Event.fire(document,":error",{text:a,element:c,major:b})}},content:{set:function(a){a={content:a};Event.fire(document,":content.set",a);miniLOL.theme.content().update(a.content)},get:function(){return miniLOL.theme.content().innerHTML}},resource:{set:function(a,b){Object.isString(a)?miniLOL.resources[a]=b:miniLOL.resources[a.name]=a},get:function(a){return miniLOL.resources[a]},
reload:function(a){arguments.length>1&&(a=$A(arguments));if(Object.isArray(a))a.each(function(a){miniLOL.resource.get(a).reload()});else if(Object.isString(a))miniLOL.resource.get(name).reload();else for(var b in miniLOL.resources)miniLOL.resource.get(b).reload()}},theme:{style:{list:{},load:function(a,b,c){b=b||"#{path}/#{theme}".interpolate({path:miniLOL.theme.path,theme:miniLOL.theme.name});Event.fire(document,":theme.style.load",{name:a,path:b,overload:Boolean(c)});if(miniLOL.theme.style.exists(a,
b))if(c)miniLOL.theme.style.unload(miniLOL.theme.style.list[a],b);else return!0;a="#{path}/#{style}.css".interpolate({path:b,style:a});b=miniLOL.CSS.include(a,!0);if(!b)return!1;miniLOL.theme.style.list[a]=b;return!0},unload:function(a,b){b=b||"#{path}/#{theme}".interpolate({path:miniLOL.theme.path,theme:miniLOL.theme.name});Event.fire(document,":theme.style.unload",{name:a,path:b});var c="#{path}/#{style}.css".interpolate({path:b,style:a});miniLOL.theme.style.list[c]&&(miniLOL.theme.style.list[c].remove(),
delete miniLOL.theme.style.list[c])},exists:function(a,b){b=b||"#{path}/#{theme}".interpolate({path:miniLOL.theme.path,theme:miniLOL.theme.name});return Boolean(miniLOL.theme.style.list["#{path}/#{style}.css".interpolate({path:b,style:a})])}},template:{initialize:function(){miniLOL.theme.templates={}},setDefaults:function(){if(!miniLOL.theme.templates.list)miniLOL.theme.templates.list={};miniLOL.theme.templates.list["default"]=Object.extend({global:"<div #{attributes}>#{data}</div>",before:"#{data}",
after:"#{data}",link:'<div class="#{class}" id="#{id}">#{before}<a href="#{href}" target="#{target}" #{attributes}>#{text}</a>#{after}</div>',item:'<div class="#{class}" id="#{id}">#{before}<span #{attributes}>#{text}</span>#{after}</div>',nest:'<div class="#{class}" style="#{style}">#{data}</div>',data:'<div class="data">#{before}#{data}#{after}</div>'},miniLOL.theme.templates.list["default"]||{});miniLOL.theme.templates.list.table=Object.extend({global:"<table #{attributes}>#{data}</table>",before:"#{data}",
after:"#{data}",link:'<tr><td>#{before}</td><td><a href="#{href}" target="#{target}" #{attributes}>#{text}</a></td><td>#{after}</td></tr>',item:"<tr><td>#{before}</td><td>#{text}</td><td>#{after}</td></tr>",nest:'<div class="#{class}" style="#{style}">#{data}</div>',data:'<div class="data">#{before}#{data}#{after}</div>'},miniLOL.theme.templates.list.table||{});if(!miniLOL.theme.templates.menu)miniLOL.theme.templates.menu={};miniLOL.theme.templates.menu.layers=Object.extend({0:{menu:'<div class="menu">#{data}</div>',
item:'<span class="item"><a href="#{href}">#{text}</a></span>'}},miniLOL.theme.templates.menu.layers||{})}},load:function(a,b,c){miniLOL.theme.unload();var d=miniLOL.theme.path,e=miniLOL.theme.name,f=a.match(/^(.+?):(.+)$/);f?(miniLOL.theme.path=f[1],miniLOL.theme.name=f[2]):(miniLOL.theme.path="themes",miniLOL.theme.name=a);if(miniLOL.theme.name==e&&miniLOL.theme.path==d)return!0;f="#{path}/#{theme}".interpolate({path:miniLOL.theme.path,theme:a});Event.fire(document,":theme.load",{name:a,runtime:Boolean(b)});
var g;new Ajax.Request("#{path}/theme.xml".interpolate({path:f,theme:a}),{method:"get",asynchronous:!1,onSuccess:function(a){var c=miniLOL.theme.information={},a=miniLOL.Document.fix(a.responseXML);c.name=a.documentElement.getAttribute("name")||"Unknown";c.author=a.documentElement.getAttribute("author")||"Anonymous";c.homepage=a.documentElement.getAttribute("homepage")||"";miniLOL.theme.menu.node=a.documentElement.getAttribute("menu")||"menu";miniLOL.theme.content.node=a.documentElement.getAttribute("content")||
"body";try{var b=a.getElementsByTagName("initialize");miniLOL.theme.initialize=b.length?new Function(b[0].firstChild.nodeValue):new Function}catch(d){return g="An error occurred on the theme#initialize function:\n\n"+d.toString(),!1}try{var f=a.getElementsByTagName("finalize");miniLOL.theme.finalize=f.length?new Function(f[0].firstChild.nodeValue):new Function}catch(e){return g="An error occurred on the theme#finalize function:\n\n"+e.toString(),!1}c.styles=[];a.xpath("/theme/styles/style").each(function(a){c.styles.push(a.getAttribute("name"))});
a.xpath("/theme/templates/*").each(function(a){miniLOL.theme.templates[a.nodeName]=Element.toObject(a)},this);miniLOL.theme.template.setDefaults()},onFailure:function(){g="Could not load theme#information."}});if(g)return miniLOL.error(g,!0),!1;if(d=miniLOL.utils.get("#{path}/template.html".interpolate({path:f,theme:a}),{minified:!0}))$(document.body).update(d);else return miniLOL.error("Could not load template.html.",!0),!1;miniLOL.theme.information.styles.each(function(a){if(!miniLOL.theme.style.load(a,
!1,!0))throw miniLOL.error("Could not load `#{style}` style/".interpolate({style:a}),!0),$break;});if(miniLOL.error())return!1;b&&miniLOL.initialized&&(miniLOL.menu.change(miniLOL.menu.current,!0),miniLOL.go(location.href));miniLOL.theme.tmp={};!c&&miniLOL.theme.initialize&&miniLOL.theme.initialize.call(miniLOL.theme.tmp);Event.fire(document,":theme.loaded",{name:a,runtime:Boolean(b)});return!0},unload:function(a){miniLOL.theme.template.initialize();miniLOL.theme.name&&(Event.fire(document,":theme.unload",
{name:miniLOL.theme.name}),!a&&miniLOL.theme.finalize&&miniLOL.theme.finalize.call(miniLOL.theme.tmp||{}),delete miniLOL.theme.tmp,$A(miniLOL.theme.information.styles).each(function(a){miniLOL.theme.style.unload(a)}),delete miniLOL.theme.name,delete miniLOL.theme.initialize,delete miniLOL.theme.finalize,delete miniLOL.theme.information)},content:function(){return $(miniLOL.theme.content.node)},menu:function(){return $(miniLOL.theme.menu.node)},deprecated:function(){miniLOL.theme.path="themes";miniLOL.theme.content.node=
miniLOL.config.core.contentNode||"body";miniLOL.theme.menu.node=miniLOL.config.core.menuNode||"menu";miniLOL.theme.template.initialize();new Ajax.Request("resources/template.html",{method:"get",asynchronous:!1,onSuccess:function(a){$(document.body).update(a.responseText)},onFailure:function(){$(document.body).update('<div id="menu"></div><div id="body"></div>')}});miniLOL.CSS.include("resources/style.css");miniLOL.theme.template.setDefaults();return!0}},menu:{set:function(a){miniLOL.menu.enabled()&&
miniLOL.theme.menu().update(a)},get:function(a,b){b=b||0;if(!miniLOL.menu.enabled())return"";a=a||"default";return!miniLOL.menu.exists(a)?null:miniLOL.menu.parse(miniLOL.menus[a],b)},change:function(a,b){if(a!=miniLOL.menu.current||b){var c=miniLOL.menu.get(a);if(c)miniLOL.menu.set(c),miniLOL.menu.current=a;else return c="The menu `#{name}` does not exist.".interpolate({name:a}),miniLOL.error(c,!0),c;Event.fire(document,":menu.change",miniLOL.menus[a])}},enabled:function(){return Boolean(miniLOL.menus["default"])},
exists:function(a){return Boolean(miniLOL.menus[a])},parse:function(a,b){var b=b||0,c=miniLOL.theme.templates.menu;if((!c||!a)&&miniLOL.error())return!1;var d=!0,e="";$A(a.childNodes).each(function(a){switch(a.nodeType){case Node.ELEMENT_NODE:e+=a.nodeName=="menu"?miniLOL.menu.parsers.layer(c,b).menu.interpolate({data:miniLOL.menu.parse(a,b)}):a.nodeName=="item"?miniLOL.menu.parsers.item(a,c,b):miniLOL.menu.parsers.other(a,c);break;case Node.CDATA_SECTION_NODE:case Node.TEXT_NODE:d||(e+=a.nodeValue),
d=!1}});return e.blank()?"":b==0?miniLOL.menu.parsers.layer(c,b).menu.interpolate({data:e}):e},parsers:{layer:function(a,b){var c={menu:"",item:""};if(a){c=Object.extend(c,a.layers["_"+b]||a.layers["default"]||{});if(!c.menu)c.menu="#{data}";if(!c.item)c.item='<a href="#{href}" #{attributes}>#{text}</a> '}return c},item:function(a,b,c){var d=a.cloneNode(!0),e=d.getAttribute("class")||"";d.removeAttribute("class");var f=d.getAttribute("id")||"";d.removeAttribute("id");var g=d.getAttribute("href")||
...
Object.fromAttributes(a.attributes)))}}},page:{get:function(a,b,c){miniLOL.content.set(miniLOL.config.core.loadingMessage);Event.fire(document,":page.get",{name:a,queries:b});var d=miniLOL.page.current=miniLOL.pages.data[a],e=b.type;if(!d)return miniLOL.content.set("404 - Not Found"),!1;if(d.getAttribute("alias")){typeof b[a]!="string"&&delete b[a];delete b.page;if(!b.title&&d.getAttribute("title"))b.title=d.getAttribute("title").encodeURIComponent();(b=Object.toQueryString(b))&&(b="&"+b);d=d.getAttribute("alias");
!d.isURL()&&d.charAt(0)!="#"&&(d="#"+d);return miniLOL.go(d+b)}Object.isUndefined(e)&&(e=d.getAttribute("type"));if(c)c={},Object.extend(c,miniLOL.config.core),Object.extend(c,b),document.title=(b.title||d.getAttribute("title")||miniLOL.config.core.siteTitle).interpolate(c);if(miniLOL.pages.cache[a])return e?miniLOL.content.set(miniLOL.resource.get("miniLOL.functions").render(e,miniLOL.pages.cache[a],b)):miniLOL.content.set(miniLOL.pages.cache[a]),!0;if(c=d.getAttribute("arguments")){var c=c.replace(/[ ,]+/g,
"&amp;").toQueryParams(),f;for(f in c)b[f]==null&&(b[f]=c[f])}d=miniLOL.page.parse(d);miniLOL.pages.cache[a]=d;e&&(d=miniLOL.resource.get("miniLOL.functions").render(e,d,b));miniLOL.content.set(d);return!0},parse:function(a,b){var c="";$A(a.childNodes).each(function(a){switch(a.nodeType){case Node.ELEMENT_NODE:Object.isFunction(miniLOL.page.parsers[a.nodeName])&&(c+=miniLOL.page.parsers[a.nodeName](a,b));break;case Node.CDATA_SECTION_NODE:case Node.TEXT_NODE:c+=a.nodeValue}});return c},parsers:{list:function(a,
b){var c=a.cloneNode(!1),b=b||[a],d=c.getAttribute("before")||b[0].getAttribute("before")||"";c.removeAttribute("before");var e=c.getAttribute("after")||b[0].getAttribute("after")||"";c.removeAttribute("after");var f=c.getAttribute("arguments")||b[0].getAttribute("arguments")||"";c.removeAttribute("arguments");var g=c.getAttribute("type")||b[0].getAttribute("type")||"";c.removeAttribute("type");var j=c.getAttribute("menu")||b[0].getAttribute("menu");c.removeAttribute("menu");var h=c.getAttribute("template");
c.removeAttribute("template");miniLOL.theme.templates.list[h]||(h="default");var k="";$A(a.childNodes).each(function(c){if(c.nodeType==Node.ELEMENT_NODE)if(c.nodeName=="link"){var b=c.cloneNode(!0),i=b.getAttribute("href");b.removeAttribute("href");var l=b.getAttribute("target");b.removeAttribute("target");var c=b.getAttribute("text")||(b.firstChild?b.firstChild.nodeValue:i),o=b.getAttribute("before")||d||"";b.removeAttribute("before");var p=b.getAttribute("after")||e||"";b.removeAttribute("after");
...
":page.loaded",a)}})}},module:{create:function(a,b){if(!b)return miniLOL.error("Like, do I know how this module is done?",!0),!1;Event.fire(document,":module.create",{name:a,module:b});b.name=a;b.root="#{path}/#{module}".interpolate({path:miniLOL.module.path,module:a});if(!Object.isArray(b.dependencies))b.dependencies=[];if(!b.type)b.type="active";if(!b.execute)b.execute=new Function;for(var c in b)Object.isFunction(b[c])&&(b[c]=b[c].bind(b));b.storage=new miniLOL.Storage("module."+a);if(b.initialize)try{if(b.initialize()===
!1){if(miniLOL.error())return!1;throw Error("An error occurred while initializing the module.");}}catch(d){throw d.fileName="#{root}/#{path}/#{module}/main.js".interpolate({root:miniLOL.path,path:miniLOL.module.path,module:a}),d;}miniLOL.modules[a]=b;$A(b.aliases).each(function(a){miniLOL.modules[a]=b});document.fire(":module.created",b);return b},execute:function(a,b,c){if(!a)return miniLOL.error("What module should be executed?"),!1;if(!miniLOL.module.exists(a))return c&&miniLOL.error("The module `#{name}` is not loaded.".interpolate({name:a})),
!1;if(c)miniLOL.content.set(miniLOL.config.core.loadingMessage),c={},Object.extend(c,miniLOL.config.core),Object.extend(c,b),document.title=(b.title||miniLOL.module.get(a).title||miniLOL.config.core.siteTitle).interpolate(c);b=Object.isArray(b)?b:[b];Event.fire(document,":module.execute",{name:a,arguments:b});var d;try{d=miniLOL.module.get(a).execute.apply(miniLOL.module.get(a),b)}catch(e){return e.fileName="#{root}/#{path}/#{module}/main.js".interpolate({root:miniLOL.path,path:miniLOL.module.path,
module:a}),miniLOL.error("An error occurred while executing the module `#{name}`\n\n#{file} @ #{line}:\n#{error}".interpolate({name:a,file:e.fileName,line:e.lineNumber,error:e.toString()}),!0),!1}Event.fire(document,":module.executed",{name:a,arguments:b,result:d});Object.isUndefined(d)&&(d=!0);return d},load:function(a){Event.fire(document,":module.load",a);try{miniLOL.utils.require("#{path}/#{module}/main.js".interpolate({path:miniLOL.module.path,module:a}),{minified:!0});if(miniLOL.error())return!1;
if(!miniLOL.module.exists(a))throw Error("Something went wrong while loading the module `#{name}`.".interpolate({name:a}));Event.fire(document,":module.loaded",a);return!0}catch(b){return miniLOL.error("An error occurred while loading the module `#{name}`\n\n#{root}/#{file} @ #{line}:\n\n#{error}".interpolate({name:a,root:miniLOL.path,file:b.fileName,line:b.lineNumber,error:b.toString()}),!0),!1}},get:function(a){return miniLOL.modules[a]},exists:function(a){return Boolean(miniLOL.module.get(a))},
dependencies:{check:function(){for(var a in miniLOL.modules){var b=miniLOL.module.get(a).dependencies;if(b)for(var c=0;c<b.length;c++)if(!miniLOL.module.get(b[c]))throw{module:a,require:b[c]};}return!0},needs:function(a,b,c,d){miniLOL.module.get(a)?b.call(c||window):setTimeout(function(){miniLOL.module.dependencies.needs(a,b,c)},d||10)}}},go:function(a,b){if(!Object.isString(a))return!1;a.isURL()?(a=a.parseURL(),a.host!=location.host||!a.path.startsWith(miniLOL.path)?location.href=a.full:a=a.full.replace(RegExp("^.*"+
miniLOL.path),"")):a.charAt(0)!="#"&&(a="#"+a);var a=a.replace(/#!/,"#"),c=a.toQueryParams(),d=a.match(/#(([^=&]*)&|([^=&]*)$)/),e=!1;c.menu&&miniLOL.menu.change(c.menu);miniLOL.page.current=null;d?(c.page=d[2]||d[3],c.page?e=miniLOL.page.get(c.page,c,a):b||(e=miniLOL.go("#{page}&#{queries}".interpolate({page:miniLOL.config.core.homePage,queries:Object.toQueryString(c)}),!0))):c.module?e=miniLOL.module.execute(c.module,c,!0):c.page?(d=c.page,delete c.page,miniLOL.page.load(d,c,a)):e=miniLOL.go(miniLOL.config.core.homePage);
e&&Event.fire(document,":go",a.getHashFragment());return e}};
...
Class.create({parseFromString:function(a){var b=new AciveXObject("Microsoft.XMLDOM");b.async="false";b.loadXML(a);return b}});if(!window.XMLSerializer)window.XMLSerializer=Class.create({serializeToString:function(a){return a.xml}})}})();Function.empty=function(){};Object.extend(Function,function(){return{parse:function(a){matches=a.match(/^function\s*\((.*?)\)[\s\n]*\{([\s\S]*)\}[\s\n]*/m);if(!matches)return null;a=matches[1].split(/\s*,\s*/);return new Function(a,matches[2])}}}());
Object.extend(Function.prototype,function(){return{clone:function(){return Function.parse(this.toString())}}}());
Object.extend(Object,function(){var a,b;if(function(){for(var a in{toString:1})if(a==="toString")return!1;return!0}()){var c=Object.keys,d=Object.values,e=["toString","valueOf"];a=function(a){var b=c(a);e.each(function(c){a[c]!=Object.prototype[c]&&b.push(c)});return b};b=function(a){var c=d(a);e.each(function(b){a[b]!=Object.prototype[b]&&c.push(a[b])});return c}}else a=Object.keys,b=Object.values;var f=Object.isFunction(Object.defineProperty)?Object.defineProperty:function(a,c,b){Object.isFunction(b.get)&&
...
Object.extend(Number.prototype,function(){function a(){return this*1E3}function b(){return this}function c(){return this*60}function d(){return this*3600}function e(){return this*86400}function f(){return this*604800}function g(){return this*324E5}return{milliseconds:a,ms:a,seconds:b,second:b,minutes:c,minute:c,hours:d,hour:d,days:e,day:e,weeks:f,week:f,years:g,year:g,upTo:function(a,c,b){$R(this,a+1,!0).each(c,b);return this},isEven:function(){return this%2==0},isOdd:function(){return this%2!=0},
...
(function(){Date.weekDays=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"];Date.months=["January","February","March","April","May","June","July","August","September","October","November","December"];var a={d:2,H:2,I:2,j:3,k:2,l:2,m:2,M:2,N:9,S:2,U:2,V:2,W:2,y:2,i:3};Object.extend(Date,function(){var a=Date.parse;return{parse:function(b){if(!b.include("%"))return a(b)}}}());var b={flag:{"-":function(a){return a},_:function(a,b){return a.toPaddedString(b,10," ")},0:function(a,
...
e["__miniLOL.Class__"]=!0;Object.extend(e,Class.Methods);e.superclass=d;e.subclasses=[];if(d){if(!d.__type__)d.__type__=a.Normal;if(!d.subclasses)d.subclasses=[];var f=Function.empty.clone();f.prototype=d.prototype;e.prototype=new f;d.subclasses.push(e)}e.__type__=e.prototype.__type__=b.first().type||Class.Normal;b.each(function(a){e.addMethods({initialize:a.initialize||a.constructor||Function.empty.clone()});e.addMethods(Object.without(a,["constructor","initialize","Methods","Static","Attributes"]));
...
miniLOL.utils=function(){return{exists:function(a){var b=!1;new Ajax.Request(a,{method:"head",asynchronous:!1,evalJS:!1,onSuccess:function(){b=!0}});return b},get:function(a,b){var b=Object.extend({raw:!0},b||{}),c;new Ajax.Request(a,Object.extend(b||{},{method:"get",asynchronous:!1,evalJS:!1,onSuccess:function(a){if(b.raw)c=a.responseText;else try{c=JSON.unserialize(a.responseText)}catch(e){c=a.responseXML||a.responseText}}}));return c},execute:function(a,b){var c,d;new Ajax.Request(a,Object.extend(b||
{},{method:"get",asynchronous:!1,evalJS:!1,onSuccess:function(b){try{c=window.eval(b.responseText)}catch(f){d=f,d.fileName=a,d.lineNumber-=5}},onFailure:function(b){d=Error("Failed to retrieve `#{file}` (#{status} - #{statusText}).".interpolate({file:a,status:b.status,statusText:b.statusText}));d.fileName=a;d.lineNumber=0}}));if(d)throw d;return c},include:function(a,b){b=b||{};if(a.startsWith("http")){var c=new Element("script",{type:"text/javascript",src:a,id:b.id});$(document.head).insert(c);return!0}var d=
!1;new Ajax.Request(a,Object.extend(b||{},{method:"get",asynchronous:!1,evalJS:!1,onSuccess:function(a){try{window.eval(a.responseText),d=!0}catch(b){d=!1}}}));return d},require:function(a,b){b=b||{};if(a.startsWith("http")){var c=new Element("script",{type:"text/javascript",src:a,id:b.id});$(document.head).insert(c);return!0}var d=!1;new Ajax.Request(a,Object.extend(b||{},{method:"get",asynchronous:!1,evalJS:!1,onSuccess:function(b){try{window.eval(b.responseText)}catch(c){d=c,d.fileName=a,d.lineNumber-=
5}},onFailure:function(b){d=Error("Failed to retrieve `#{file}` (#{status} - #{statusText}).".interpolate({file:a,status:b.status,statusText:b.statusText}));d.fileName=a;d.lineNumber=0;d.http={status:b.status,text:b.statusText}}}));if(d)throw d;return!0}}}();
miniLOL.File=Class.create({initialize:function(a,b){this.options=Object.extend({method:"get",asynchronous:!1,evalJS:!1,minified:!1,cached:!0,onSuccess:function(a){this.content=a.responseText;this.special=a.responseXML;this.loaded=!0;if(Object.isFunction(this.options.onLoaded))this.options.onLoaded(this)}.bind(this),onFailure:function(a){this.error=Object.clone(a)}.bind(this)},b||{});this.loaded=!1;this.path=a;this.extension=miniLOL.File.extension(a);new Ajax.Request(this.path,this.options)},reload:function(){this.loaded=
!1;new Ajax.Request(this.path,this.options)},interpolate:function(a,b){return b?this.content.interpolate(a,b):(new miniLOL.Template(this)).evaluate(a)},Static:{extension:function(a){return(a=a.match(/\.([^.]+)$/))?a[1]:""}}});
...
b){return this.template.evaluate(a,b)}});miniLOL.Template.Engine=function(){var a={},b={};return{get:function(b){return a[(b||"").toLowerCase()]},add:function(b,d){a[b.toLowerCase()]||(a[b.toLowerCase()]=d)},load:function(a,d){b[a]||(miniLOL.utils.execute(a,d),b[a]=!0)}}}();
...
this.toJSON(!0);this.size=a.length;window.localStorage["__miniLOL.storage."+this.name]=a}}),GlobalStorage:Class.create(miniLOL.Storage.Backend,{initialize:function($super,b){$super(b);this.replace(window.globalStorage[window.location.hostname]["__miniLOL.storage."+this.name]||"{}")},save:function(){var a=this.toJSON(!0);this.size=a.length;window.globalStorage[window.location.hostname]["__miniLOL.storage."+this.name]=a}}),UserDataBehavior:Class.create(miniLOL.Storage.Backend,{initialize:function($super,
b){$super(b);this.element=document.createElement("link");this.element.addBehavior("#default#userData");$$("head")[0].appendChild(this.element);this.element.load("__miniLOL.storage."+b);var c=this.element.getAttribute("__miniLOL.storage."+this.name)||"{}";this.size=c.length;this.replace(c)},save:function(){var a=this.toJSON(!0);this.size=a.length;this.element.setAttribute("__miniLOL.storage."+this.name,a);this.element.save("__miniLOL.storage."+this.name)}}),Cookie:Class.create(miniLOL.Storage.Backend,
{initialize:function($super,b){$super(b);this.replace(miniLOL.Cookie.get("__miniLOL.storage."+this.name,{raw:!0})||"{}")},save:function(){var a=this.toJSON(!0);this.size=a.length;miniLOL.Cookie.set("__miniLOL.storage."+this.name,a,{expires:31536E3,raw:!0})}}),Null:Class.create(miniLOL.Storage.Backend,{save:Function.empty})};
...
Checkers:{Default:function(){miniLOL.History.current!=window.location.hash&&Event.fire(document,":url.change",Prototype.Browser.Mozilla?window.location.hash||"#":decodeURIComponent(window.location.hash||"#"))},InternetExplorer:function(){var a={iframe:miniLOL.History.IE.get(),actual:window.location.hash||"#",current:miniLOL.History.current};if(a.actual!=a.iframe)a.actual&&a.actual==a.current?window.location.hash=(miniLOL.History.current=a.iframe).substring(1):miniLOL.History.IE.put(miniLOL.History.current=
