...
!0)}});if(miniLOL.error())return!1;return!0},clear:function(){miniLOL.modules=this.data={}}}));miniLOL.resource.get("miniLOL.modules").load("resources/modules.xml",!0)},function(){miniLOL.menu.enabled()&&miniLOL.menu.change("default")},function(){miniLOL.content.set("Checking dependencies...");try{miniLOL.module.dependencies.check()}catch(a){miniLOL.error("`#{module}` requires `#{require}`".interpolate(a),!0)}}].each(function(a){try{a()}catch(b){miniLOL.error(b.toString(),!0)}if(miniLOL.error())throw $break;
...
Object.fromAttributes(a.attributes)))}}},page:{get:function(a,b,c){miniLOL.content.set(miniLOL.config.core.loadingMessage);Event.fire(document,":page.get",{name:a,queries:b});var d=miniLOL.pages.data[a],e=b.type;if(!d)return miniLOL.content.set("404 - Not Found"),!1;if(d.getAttribute("alias")){typeof b[a]!="string"&&delete b[a];delete b.page;if(!b.title&&d.getAttribute("title"))b.title=d.getAttribute("title").encodeURIComponent();(b=Object.toQueryString(b))&&(b="&"+b);d=d.getAttribute("alias");!d.isURL()&&
d.charAt(0)!="#"&&(d="#"+d);return miniLOL.go(d+b)}Object.isUndefined(e)&&(e=d.getAttribute("type"));if(c)c={},Object.extend(c,miniLOL.config.core),Object.extend(c,b),document.title=(b.title||d.getAttribute("title")||miniLOL.config.core.siteTitle).interpolate(c);if(miniLOL.pages.cache[a])return e?miniLOL.content.set(miniLOL.resource.get("miniLOL.functions").render(e,miniLOL.pages.cache[a],b)):miniLOL.content.set(miniLOL.pages.cache[a]),!0;if(c=d.getAttribute("arguments")){var c=c.replace(/[ ,]+/g,
...
Object.extend(String,function(){return{fromAttributes:function(a){for(var b="",c=0;c<a.length;c++)b+='#{name}="#{value}" '.interpolate({name:a.item(c).nodeName,value:a.item(c).nodeValue});return b},fromXML:function(a){if(!Object.isXML(a))return!1;return(new XMLSerializer).serializeToString(a)}}}());
...
{},{method:"get",asynchronous:!1,evalJS:!1,onSuccess:function(b){try{c=window.eval(b.responseText)}catch(f){d=f,d.fileName=a,d.lineNumber-=5}},onFailure:function(b){d=Error("Failed to retrieve `#{file}` (#{status} - #{statusText}).".interpolate({file:a,status:b.status,statusText:b.statusText}));d.fileName=a;d.lineNumber=0}}));if(d)throw d;return c},include:function(a,b){b=b||{};if(a.startsWith("http"))return $(document.head).insert(new Element("script",{type:"text/javascript",src:a,id:b.id})),!0;
var c=!1;new Ajax.Request(a,Object.extend(b||{},{method:"get",asynchronous:!1,evalJS:!1,onSuccess:function(a){try{window.eval(a.responseText),c=!0}catch(b){c=!1}}}));return c},require:function(a,b){b=b||{};if(a.startsWith("http"))return $(document.head).insert(new Element("script",{type:"text/javascript",src:a,id:b.id})),!0;var c=!1;new Ajax.Request(a,Object.extend(b||{},{method:"get",asynchronous:!1,evalJS:!1,onSuccess:function(b){try{window.eval(b.responseText)}catch(e){c=e,c.fileName=a,c.lineNumber-=
5}},onFailure:function(b){c=Error("Failed to retrieve `#{file}` (#{status} - #{statusText}).".interpolate({file:a,status:b.status,statusText:b.statusText}));c.fileName=a;c.lineNumber=0;c.http={status:b.status,text:b.statusText}}}));if(c)throw c;return!0}}}();
