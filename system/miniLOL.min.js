...
(j instanceof e||j==e)},isObject:function(e){return typeof e=="object"&&e.constructor===Object},isBoolean:function(e){return typeof e=="boolean"||e.constructor===Boolean},isRegExp:function(e){return!Object.isUndefined(e)&&e.constructor==window.RegExp},isClass:function(e){return Boolean(e["__miniLOL.Class__"])},isDocument:function(e){return e.toString().include("Document")},isXML:function(e){if(typeof e!=="object")return false;e=e.ownerDocument||e;if(!e.documentElement)return false;return e.documentElement.nodeName!=
...
miniLOL.utils=function(){return{exists:function(a){var c=false;new Ajax.Request(a,{method:"head",asynchronous:false,evalJS:false,onSuccess:function(){c=true}});return c},get:function(a,c){c=Object.extend({raw:true},c);var b;new Ajax.Request(a,Object.extend(c||{},{method:"get",asynchronous:false,evalJS:false,onSuccess:function(d){b=d.request.options.raw?d.responseText:d.responseXML||d.responseText}}));return b},execute:function(a,c){var b,d;new Ajax.Request(a,Object.extend(c||{},{method:"get",asynchronous:false,
