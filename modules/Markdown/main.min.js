...
Event.observe(document,":go",function(){this.execute()}.bind(this))},execute:function(a){if(Object.isString(a))return this.converter.makeHtml(a)||a;else a=Object.isElement(a)?[a]:$$(".#{0}".interpolate([miniLOL.config.Markdown["class"]]));a.each(function(b){b.innerHTML=this.converter.makeHtml(b.innerHTML)},this)}});
